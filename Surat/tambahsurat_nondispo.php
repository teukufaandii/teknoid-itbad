...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Menggabungkan nama-nama mahasiswa ke dalam satu string
    $nama_lengkap_mahasiswa = implode(", ", $nama_lengkap);

    // Menggabungkan NIM mahasiswa ke dalam satu string
    $nim_mahasiswa = implode(", ", $nim);
    ...
    if (isSuratKKL($jenis_surat)) {
        ...
        $sql = "INSERT INTO tb_surat_dis (jenis_surat, asal_surat, perihal, nomor_surat, tanggal_surat, 
                        tujuan_surat, email, nama_lengkap, nim, prodi, no_hp, nama_perusahaan, alamat_perusahaan, deskripsi, diteruskan_ke)
            VALUES ('$jenis_surat', '$asal_surat', '$perihal', '$nomor_surat', '$tanggal_surat', '$tujuan_surat', 
                    '$email', '$nama_lengkap_mahasiswa', '$nim_mahasiswa', '$prodi', '$no_hp', '$nama_perusahaan', '$alamat_perusahaan', '$deskripsi', '$ke_humas')";
        ...
        $sql = "INSERT INTO tb_surat_dis (jenis_surat, asal_surat, perihal, nomor_surat, tanggal_surat, 
                    ...
                    VALUES ('$jenis_surat', '$asal_surat', '$perihal', '$nomor_surat', '$tanggal_surat', '$tujuan_surat', '$email', 
                            '$nama_lengkap_mahasiswa', '$nim_mahasiswa', '$prodi', '$no_hp', '$nama_perusahaan', '$alamat_perusahaan', '$deskripsi', '$ttl', '$alamat_domisili', '$ke_humas')";
    }
                    ...
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form" enctype="multipart/form-data">
                        ...
                        <div id="mahasiswa_fields">
                            ...
                            <div class="inputfield">
                                ...
                                <input type="text" class="input" name="nim[]" placeholder="Masukkan NIM Mahasiswa 1">
                            </div>
                            ...
                            <div class="inputfield" id="mahasiswa2" style="display: none;">
                                ...
                                <input type="text" class="input" name="nama_lengkap[]" placeholder="Masukkan Nama Mahasiswa 2">
                            </div>
                            <div class="inputfield" id="nim_mahasiswa2" style="display: none;" id="mahasiswa_fields2"> 
                                <label for="nim_mahasiswa2">NIM Mahasiswa <b>2</b>*</label>
                                <input type="text" class="input" name="nim[]" placeholder="Masukkan NIM Mahasiswa 2">
                            </div>
                            ...
                            <div class="inputfield" id="mahasiswa3" style="display: none;">
                                ...
                                <input type="text" class="input" name="nama_lengkap[]" placeholder="Masukkan Nama Mahasiswa 3">
                            </div>
                            <div class="inputfield" id="nim_mahasiswa3" style="display: none; margin-bottom: 15px;">
                                <label for="nim_mahasiswa3">NIM Mahasiswa <b>3</b>*</label>
                                <input type="text" class="input" name="nim[]" placeholder="Masukkan NIM Mahasiswa 3">
                            </div>
                        </div>
