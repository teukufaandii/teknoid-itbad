                                ...
                                <tr>
                                    <?php
                                        ...
                                        if ($_SESSION['akses'] == 'Rektor') {
                                            ...
                                            if ($row['diteruskan_ke'] == 'Warek1' || $row['dispo2'] == $jabatan || 
                                            ...
                                            if (strpos($row['diteruskan_ke'], 'DekanFTD') !== false && strpos($row['diteruskan_ke'], 'DekanFEB') !== false || strpos($row['diteruskan_ke'], 'DekanFTD')
                                            ...
                                            if (strpos($row['diteruskan_ke'], 'DekanFTD') !== false && strpos($row['diteruskan_ke'], 'DekanFEB') !== false || $row['diteruskan_ke'] == $akses
                                            ...
                                            if ($row['diteruskan_ke'] == $akses || strpos($row['diteruskan_ke'], 'direkPasca') ||  $row['dispo2'] == 'direkPasca' || 
                                            ...
                                            // section unit
                                        } elseif ($_SESSION['akses'] == 'ppik_mhs') {
                                            if (strpos($row['diteruskan_ke'], $akses) !== false || $row['diteruskan_ke'] == $akses){
                                            // if ($row['diteruskan_ke'] == 'ppik' || $row['diteruskan_ke'] == 'bag_keuangan' || 
                                            //     $row['diteruskan_ke'] == 'akademik' || $row['diteruskan_ke'] == 'umum'
                                            //     || $row['diteruskan_ke'] == 'kui' || $row['diteruskan_ke'] == 'marketing' || 
                                            //     $row['diteruskan_ke'] == 'upt_perpus' || $row['diteruskan_ke'] == 'sdm'
                                            //     || $row['diteruskan_ke'] == 'bpm' || $row['diteruskan_ke'] == 'lp3m' || 
                                            //     $row['diteruskan_ke'] == 'it_lab' || $row['diteruskan_ke'] == 'keuangan') {
                                            ...
                                            if (strpos($row['diteruskan_ke'], $akses) !== false || $row['diteruskan_ke'] == $akses || $row['dispo3'] == $jabatan ||
                                            $row['dispo4'] == $jabatan){
                                                echo "<td style=\"min-width: 75px;\">" . $counter++ . "</td>";
                                                echo "<td>" . $row['kode_surat'] . "</td>";
                                                echo "<td>" . $row['asal_surat'] . "</td>";
