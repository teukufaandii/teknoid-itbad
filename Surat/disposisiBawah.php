...
<?php } elseif ($_SESSION['akses'] == 'Humas') { ?>
    ...
    $koneksi = mysqli_connect("localhost", "teknoid1_admin", "RadKrwY8qt3v", "teknoid1_db_teknoid");    $query_jenis_surat = "SELECT jenis_surat FROM tb_surat_dis WHERE id_surat = '$id'";
