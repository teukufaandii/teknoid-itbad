...
if (isset($_POST['id']) && isset($_POST['catatan_disposisi']) && isset($_POST['action'])) {
    ...
    // Determine the update query for tb_disposisi based on user's role and action
    if (isset($_SESSION['akses']) && $_SESSION['akses'] == 'Humas') {
        // Update for Humas role
        ...
        if ($action == 'selesai' && !$tanggal_eksekutor && !$nama_selesai && !$catatan_selesai) {
        ...
        } elseif ($action == 'selesai' && $tanggal_eksekutor && $nama_selesai && $catatan_selesai &&
